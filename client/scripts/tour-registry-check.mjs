...
const EXPECTED = [
  ...
  { path: "/dashboard/companies/xyz/website-builder/edit-website", expectedId: "company-website-builder-editor" },
  { path: "/dashboard/companies/xyz/website-builder/edit-website/biz-nest", expectedId: "company-website-builder-editor" },
  { path: "/dashboard/host-companies/abc/website-builder/edit-website", expectedId: "company-website-builder-editor" },
