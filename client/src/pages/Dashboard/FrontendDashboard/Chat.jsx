                                    ...
                                    <ul className="space-y-2">
                                        {filteredContacts.map((contact) => (
                                            <li key={contact.id} className="space-y-1">
                                                <div
                                                    className={`flex items-center justify-between p-3 rounded-lg cursor-pointer transition-all ${activeContact.id === contact.id ||
                                                        (contact.subGroups &&
                                                ...
                                                {contact.subGroups && expandedGroup === contact.id && (
                                                    <ul className="pl-4 space-y-1">
                                                        {contact.subGroups.map((subGroup, idx) => (
                                                            <li
                                                                key={idx}
                                                                className={`p-2 rounded-lg cursor-pointer ${activeContact.name === subGroup
                                                                    ? "bg-blue-100 text-blue-700"
                                                                    : "hover:bg-gray-100"
                                                                    }`}
                                                                onClick={() =>
                            ...
                            {messages.map((msg, index) => {
                                ...
                                return (
                                    <div
                                        ...
                                        <div
                                            className={`w-40 p-3 rounded-lg overflow-hidden ${msg.fromMe ? "bg-blue-200" : "bg-purple-100"
                                                } shadow`}>
