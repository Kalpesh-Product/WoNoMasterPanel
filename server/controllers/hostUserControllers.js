...
//     // Fetch existing POCs to check for duplicates
...
//       if (!companyId || !pocName) {
//         continue;
//       }

//       // Get company MongoDB ID
...
//       // Create unique key for this POC (name + companyId)
//       const pocKey = `${pocName.toLowerCase()}|${companyId}`;

//       // Check if this POC already exists in DB
